...
import type { GenerateScheduleV3Input, GeneratedShiftV3, SchedulerConfigV3, EmployeeV3 } from '../scheduler-engine-v3/types.ts';
...
export function refreshDraftPeopleV3(draft:DraftV3,employees:EmployeeV3[],absences:Array<Record<string,any>>):DraftV3 {
  ...
  people.push(...employees.filter(e=>!ids.has(e.id)).map(e=>({...e,schedulerV3:normalizeEmployeeProfileV3()})));
  return {...draft,employees:people,absences:mapAbsencesV3(absences,draft.periodStart,draft.periodEnd)};
}
export type DraftV3 = GenerateScheduleV3Input & { id: string; shifts: GeneratedShiftV3[]; revision?: number };
